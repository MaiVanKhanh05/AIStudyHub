...
$Bytes = [System.Text.Encoding]::UTF8.GetBytes($mermaid)
Invoke-RestMethod -Uri "https://kroki.io/mermaid/png" -Method Post -Body $Bytes -ContentType "text/plain; charset=utf-8" -OutFile "c:\github\AIStudyHub\docs\authentication_swimlane.png"
